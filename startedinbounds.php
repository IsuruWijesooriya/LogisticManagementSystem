...
<body>
    <div style="background: #A7A7A7;">
        ...
        &emsp;<button class="button" onclick="window.location.href='inbound1.php'"><b>Back</b></button>
        </center><br>
    </div>
    <br>
    <main>
    ...
    $name = $row['fullname'];
    $state2="ongoing";
    $sql3 = "SELECT * FROM inbound WHERE confirm = '$state2' AND user = '$name'";
    ...
    <td><button class="tbtn" onclick="location.href='viewstartedinbounds.php?id=<?php echo $id3; ?>'">View</button></td>
    </tr>
    <?php 
    }
    ?>
