...
<body>
    <div style="background: #A7A7A7;">
        ...
        &emsp;<button class="button" onclick="window.location.href='viewpickup.php'"><b>Back</b></button>
        </center><br>
    </div>
    <br>
    <main>
    ...
    $state2="ongoing";
    $sql3 = "SELECT * FROM pickup WHERE confirm = '$state2'";
    ...
    <td><button class="tbtn" onclick="location.href='viewjob4.php?id=<?php echo $id3; ?>'">View</button></td>
    </tr>
    <?php 
    }
    ?>
