...
<body>
    ...
    <main>
    <div class="container">
        <center><button class="bttn" style="background: #087E73;" onclick="window.location.href='startedinbounds.php'"><center><b>Started Inbound</b></center></button></center>
    </div>
    <div class="container">
        <center><button class="bttn" style="background: #087E0A;" onclick="window.location.href='newinbounds.php'"><center><b>New Inbounds</b></center></button></center>
    </div>
    </main>
</body>