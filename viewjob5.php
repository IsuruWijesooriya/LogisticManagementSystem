...
<body>
    <div style="background: #A7A7A7;">
        ...
        &emsp;<button class="button" onclick="window.location.href='finishedp.php'"><b>Back</b></button>
        </center><br>
    </div>
    <br>
    <main>
    ...
    <div class="container" style="background: white">
        ...
        <header><center>Job Details</center></header>
            <form action="" method="post">
                ...
                <div class="field">
                    <input type="button" class="btn" name="excel" id="excel" value="Generate Excell" onclick="location.href='excelp.php?id=<?php echo $_GET['id']; ?>'">
                </div>
    ...
    echo '</script>';
    $s="SELECT * FROM pickup WHERE id='$id3'";
    $result3 = $con->query($s);
