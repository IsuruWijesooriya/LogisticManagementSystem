...
<body>
    <div style="background: #A7A7A7;">
        ...
        &emsp;<button class="button" onclick="window.location.href='viewputaway.php'"><b>Back</b></button>
        </center><br>
    </div>
    <br>
    <main>
    ...
    <td><button class="tbtn" onclick="location.href='viewjob6.php?id=<?php echo $id3; ?>'">View</button></td>
    </tr>
    <?php 
    }
    ?>
