...
<body>
    ...
    <main>
    <div class="container">
        <center><button class="bttn" style="background: #087E73;" onclick="window.location.href='startedpickup.php'"><center><b>Started Pickup</b></center></button></center>
    </div>
    <div class="container">
        <center><button class="bttn" style="background: #087E0A;" onclick="window.location.href='newpickup.php'"><center><b>New Pickup</b></center></button></center>
    </div>
    </main>
</body>