...
<body>
    ...
    <main>
    <div class="container">
        <center><button class="bttn" style="background: #087E73;" onclick="window.location.href='startedputaway.php'"><center><b>Started Putaway</b></center></button></center>
    </div>
    <div class="container">
        <center><button class="bttn" style="background: #087E0A;" onclick="window.location.href='newputaway.php'"><center><b>New Putaway</b></center></button></center>
    </div>
    </main>
</body>